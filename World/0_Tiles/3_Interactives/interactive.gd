...
@onready var tall_grass_scene = preload("res://World/0_Tiles/3_Interactives/tallGrass/tall_grass.tscn")
@onready var tall_wheat_scene = preload("res://World/0_Tiles/3_Interactives/tallWheat/tall_wheat.tscn")
